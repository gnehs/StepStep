        ...
        <Drawer.Portal>
          ...
          <Drawer.Content className="fixed bottom-0 left-0 right-0 z-50 m-auto mt-24 flex h-max max-h-[90vh] max-w-[500px] flex-col rounded-t-[10px] bg-[#f2f2f2] dark:bg-[#222]">
            ...
            <div className="max-h-[80vh] overflow-y-auto p-4 pb-[calc(8px+env(safe-area-inset-bottom))]">
              <div className="mb-2 grid grid-cols-2 rounded-lg bg-black/5 p-1 dark:bg-black/5">
                <button
                  onClick={() => setPlatform("ios")}
                  className={twMerge(
                    "rounded-[6px] p-1 text-center",
                    platform === "ios" &&
                      "dark:glass-effect bg-white font-semibold text-black shadow-sm dark:bg-black/5 dark:text-white",
                  )}
                >
                  iOS
                </button>
